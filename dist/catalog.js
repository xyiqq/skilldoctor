export const RULE_CATALOG = [
    ...
    { id: "audit/insecure-http", severity: "warning", summary: "downloads or installs over plain HTTP" },
...
const RULE_DETAILS = {
    ...
    "audit/insecure-http": "Remote fetches over http:// can be tampered with. Use HTTPS unless the host is localhost.",
